 ...
 */
	...
	/**链接来自原第几个搜索结果页面 (int > 0)*/
	private int link_page_from;
	/**链接是原来的第几个搜索结果 (int > 0)*/
	private int link_num_from;
	/**聚合后所在的组*/
	int cluster_id;
 ...
 */
	...
	public int getLink_num_from() {
		return link_num_from;
	}
	public void setLink_num_from(int link_num_from) {
		this.link_num_from = link_num_from;
	}
