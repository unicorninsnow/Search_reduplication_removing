...
rem
rem $URL: https://svn.sourceforge.net/svnroot/htmlparser/trunk/src/main/bin/filterbuilder.cmd $
...
@echo on
%java_executable% -Xmx256M -classpath "%lib_path%filterbuilder.jar;%lib_path%htmlparser.jar;%lib_path%htmllexer.jar" org.htmlparser.parserapplications.filterbuilder.FilterBuilder %1
@echo off
goto end
:no_extensions_error
