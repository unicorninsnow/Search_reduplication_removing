...
rem
rem $URL: https://svn.sourceforge.net/svnroot/htmlparser/trunk/src/main/bin/parser.cmd $
...
@echo on
%java_executable% -classpath "%lib_path%htmlparser.jar;%lib_path%htmllexer.jar" org.htmlparser.Parser %1 %2
@echo off
goto end
:no_extensions_error
