...
rem
rem $URL: https://svn.sourceforge.net/svnroot/htmlparser/trunk/src/main/bin/thumbelina.cmd $
...
@echo on
%java_executable% -Xmx256M -classpath "%lib_path%thumbelina.jar;%lib_path%htmlparser.jar;%lib_path%htmllexer.jar" org.htmlparser.lexerapplications.thumbelina.Thumbelina %1 %2
@echo off
goto end
:no_extensions_error
